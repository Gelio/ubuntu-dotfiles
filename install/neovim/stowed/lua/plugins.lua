...
return require('packer').startup(function(use)
  ...
  use {
    ...
    config = function()
      ...
      vim.g.indent_blankline_context_patterns = { 'class', 'function', 'method',
        'if_statement', 'else_clause', 'jsx_element', 'jsx_self_closing_element',
        'try_statement', 'catch_clause', 'object', 'arguments', 'table' }
    end,
  ...
  use {
    ...
    config = function()
      local inlay_hints_options = { prefix = '', highlight = "Comment", enabled = {"TypeHint", "ChainingHint", "ParameterHint"} }
