--# selene: allow(shadowing, unused_variable, unbalanced_assignments, incorrect_standard_library_use, mismatched_arg_count, global_usage, undefined_variable, duplicate_keys)
--------------------------------------------------------------------------------------------------------------------------
-- sha2.lua
--------------------------------------------------------------------------------------------------------------------------
